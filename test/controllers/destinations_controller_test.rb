...
class DestinationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create destination" do
    assert_difference('Destination.count') do
      post destinations_url, params: { destination: { city: @destination.city, country: @destination.country, latitude: @destination.latitude, longitude: @destination.longitude } }
    end
  ...
  test "should update destination" do
    patch destination_url(@destination), params: { destination: { city: @destination.city, country: @destination.country, latitude: @destination.latitude, longitude: @destination.longitude } }
